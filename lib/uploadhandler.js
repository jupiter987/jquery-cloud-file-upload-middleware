...
module.exports = function (options) {
    ...
    UploadHandler.prototype.deleteFromS3 = function (fileName) {
        var params = {
    ...
    UploadHandler.prototype.initUrls = function (fileInfo, cb) {
        var baseUrl = (options.ssl ? 'https:' : 'http:') + '//s3.amazonaws.com/' + options.s3Bucket() + '/';
        fileInfo.setUrl(null, baseUrl + options.s3Url());
        fileInfo.setUrl('delete', this.req.originalUrl);
